...
const config = {
    ...
    TREX_CANVAS_LOCATION: new Vector2D(100, 240),
    TREX_CHANGING_INTERVAL: 100,

    MAI_CANVAS_LOCATION: new Vector2D(95, 225),

    OBSTACLE_GENERATING_INTERVAL: 2000,

    CACTUS_VELOCITY_X: 450,
    CACTUS_VELOCITY_Y: 0,
    CACTUS_CANVAS_LOCATION: new Vector2D(1500, 252),
    ...
    BACKGROUND_CANVAS_LOCATION: new Vector2D(0, 0),
